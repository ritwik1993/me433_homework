...
//    display_draw();
    ...
    while (1) {
        ...
        display_clear();
        oled_accels(~accels[0],~accels[1]);
        display_draw();
//        acc_read_register(TEMP_OUT_L, (unsigned char *) &temp, 2);
//        sprintf(message1,"Temperature : %d",temp);
//        write_string(message1,10,0);
//        display_draw();
//        acc_read_register(OUT_X_L_A, (unsigned char *) accels, 6);
//        sprintf(message2,"X Acceleration : %d",~accels[0]);
//        write_string(message2,20,0);
//        display_draw();
//        sprintf(message3,"Y Acceleration : %d",~accels[1]);
//        write_string(message3,30,0);
//        display_draw();
//        sprintf(message4,"Z Acceleration : %d",~accels[2]);
//        write_string(message4,40,0);
//        display_draw();        
    }
}
