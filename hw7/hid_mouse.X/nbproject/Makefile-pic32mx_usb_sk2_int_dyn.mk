...
# Source Files
SOURCEFILES=../src/system_config/pic32mx_usb_sk2_int_dyn/framework/system/clk/src/sys_clk_static.c ../src/system_config/pic32mx_usb_sk2_int_dyn/framework/system/ports/src/sys_ports_static.c ../src/system_config/pic32mx_usb_sk2_int_dyn/system_init.c ../src/system_config/pic32mx_usb_sk2_int_dyn/system_tasks.c ../src/system_config/pic32mx_usb_sk2_int_dyn/system_interrupt.c ../src/app.c ../src/main.c ../src/mouse.c ../../../../../../bsp/pic32mx_usb_sk2/bsp_sys_init.c ../../../../../../framework/driver/usb/usbfs/src/dynamic/drv_usb.c ../../../../../../framework/driver/usb/usbfs/src/dynamic/drv_usb_device.c ../../../../../../framework/system/devcon/src/sys_devcon.c ../../../../../../framework/system/devcon/src/sys_devcon_pic32mx.c ../../../../../../framework/system/int/src/sys_int_pic32.c ../../../../../../framework/system/ports/src/sys_ports.c ../../../../../../framework/usb/src/dynamic/usb_device.c ../../../../../../framework/usb/src/dynamic/usb_device_hid.c ../src/i2c_display.c ../src/i2c_master_int.c ../src/oled_library.c ../src/spi_accel.c
...
${OBJECTDIR}/_ext/1360937237/oled_library.o: ../src/oled_library.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/1360937237" 
	@${RM} ${OBJECTDIR}/_ext/1360937237/oled_library.o.d 
	@${RM} ${OBJECTDIR}/_ext/1360937237/oled_library.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1360937237/oled_library.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -ffunction-sections -O1 -I"../src" -I"../src/system_config" -I"../src/system_config/pic32mx_usb_sk2_int_dyn" -I"../../../../../../framework" -I"../../../../../../framework/system/common" -I"../../../../../../framework/system/devcon" -I"../../../../../../framework/system/int" -I"../../../../../../framework/system" -I"../../../../../../framework/driver/usb" -I"../../../../../../framework/usb" -I"../../../../../../bsp/pic32mx_usb_sk2" -MMD -MF "${OBJECTDIR}/_ext/1360937237/oled_library.o.d" -o ${OBJECTDIR}/_ext/1360937237/oled_library.o ../src/oled_library.c   
